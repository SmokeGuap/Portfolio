...
import skillsImage from '../assets/skillsImage.png?url';
      ...
      <div className='md:flex md:justify-between md:gap-16 mt-32'>
        ...
        <div className='mt-16 md:mt-0'>
          {isAboveMediumScreens ? (
            <div className='relative z-0 ml-20 before:absolute before:-top-10 before:-left-10 before:w-full before:h-full before:border-2 before:border-blue-300 before:z-[-1]'>
